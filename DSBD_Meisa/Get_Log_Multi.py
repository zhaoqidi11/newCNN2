...
if __name__ == '__main__':
    ...
    with open('/home/C3D/C3D-v1.1/latest_result/models/pre_train_group_pool_pad/pre_train_group_pool_pad_2_3.log') as f:
        data1 = f.read()

    with open('/home/C3D/C3D-v1.1/latest_result/logs/new_train_pool_pad_2.log') as f:
        data2 = f.read()
